...
public class IsoScelesTriangleChain extends TriangleChain {
    ...
    boolean satisfyConditions(Triangle triangle) {
        return (triangle.getSide1() == triangle.getSide2() && triangle.getSide1() != triangle.getSide3()) ||
                (triangle.getSide2() == triangle.getSide3() && triangle.getSide2() != triangle.getSide1()) ||
                (triangle.getSide3() == triangle.getSide1() && triangle.getSide3() != triangle.getSide2());
    }
